...
<body>
    ...
    <script>
        ...
        // Color interpolation function - value越大颜色越深
        function getLongColor(value, maxVal) {{
            const ratio = Math.min(value / maxVal, 1);
            const lightness = 75 - ratio * 40; // 75% -> 35% (lighter to darker)
