...
class TestDetectExtraBarFields:
    ...
    def test_standard_bar_returns_empty(self):
        ...
        from nautilus_quants.factors.engine.actor import _detect_extra_bar_fields
    ...
    def test_binancebar_detects_extra_fields(self):
        ...
        with patch(
            "nautilus_quants.factors.engine.actor._detect_extra_bar_fields"
        ) as mock_detect:
...
class TestFactorEngineExtraFields:
    ...
    def test_extra_fields_in_history(self):
        """Extra fields should appear in instrument data arrays."""
    ...
    def test_extra_fields_in_expression_evaluation(self):
        ...
        assert "avg_qv" in result.factors
        assert result.factors["avg_qv"]["BTCUSDT"] == pytest.approx(400.0)
    ...
    def test_extra_fields_in_variable_cache(self):
        ...
        assert result.factors["qv_ratio_factor"]["BTCUSDT"] == pytest.approx(5.0)
    ...
    def test_standard_bar_without_extra_fields(self):
        ...
        assert result is not None
        assert result.factors["simple"]["BTCUSDT"] == pytest.approx(50500.0)
