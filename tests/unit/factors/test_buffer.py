...
"""Tests for Buffer — rolling panel data accumulator."""
...
class TestBufferEdgeCases:
    ...
    def test_extra_fields(self) -> None:
        buf = Buffer(max_history=100, extra_fields=("quote_volume",))
